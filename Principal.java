...
public class Principal extends JFrame implements ActionListener{
    ...
    public Principal() {
        ...
        miMorado.setFont(new Font("Anadale Mono", 1, 14));
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if (e.getSource() == miElCreador){
            ...
            JOptionPane.showMessageDialog(null, "Desarrollado por Facundo Nahuel Olivera\n" + "Estudiante de Ingenieria Informatica UNLaM");
